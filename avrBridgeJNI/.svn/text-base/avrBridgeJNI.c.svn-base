...
JNIEXPORT void JNICALL Java_avrBridgeJavaDev_avr_test (JNIEnv *env, jobject obj)
{
  //  printf("\nusbInit...\n");
...
JNIEXPORT jintArray JNICALL Java_avrBridgeJavaDev_avr_getStatus  (JNIEnv *env, jobject obj) {
    jint ret[] = {0,0,0};
    ret[0] = getPort(0);
    ret[1] = getPort(1);
    ret[2] = getPort(2);
...
JNIEXPORT jint JNICALL Java_avrBridgeJavaDev_avr_setPort  (JNIEnv *env, jobject obj, jint port, jint val) {

    return setPort(port,val);
}

JNIEXPORT jint JNICALL Java_avrBridgeJavaDev_avr_setPortPin  (JNIEnv *env, jobject obj , jint port, jint pin, jint val) {

    return  setPortPin(port,pin,val);
}

JNIEXPORT jint JNICALL Java_avrBridgeJavaDev_avr_setPortPinDir  (JNIEnv *env, jobject obj, jint port, jint pin, jint dir) {

    return  setPortPinDir(port,pin,dir);
}

JNIEXPORT jint JNICALL Java_avrBridgeJavaDev_avr_getPort  (JNIEnv *env, jobject obj, jint port) {

    return  getPort(port);
}

JNIEXPORT jint JNICALL Java_avrBridgeJavaDev_avr_getPortPin  (JNIEnv *env, jobject obj, jint port, jint pin) {

    return getPortPin(port,pin);
}

JNIEXPORT jint JNICALL Java_avrBridgeJavaDev_avr_getAdc  (JNIEnv *env, jobject obj, jint pin) {

    return getAdcPortPin(1,pin);
}

JNIEXPORT jint JNICALL Java_avrBridgeJavaDev_avr_setDac  (JNIEnv *env, jobject obj, jint pin, jint val) {

    return setDac(pin,val);
}

JNIEXPORT jint JNICALL Java_avrBridgeJavaDev_avr_get (JNIEnv *env, jobject obj) {
