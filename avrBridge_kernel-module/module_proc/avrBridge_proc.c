...
static struct proc_dir_entry *avrBridge_dir, *port_dir, *pin_dir, *portB_file, *symlink;
...
static int
avrBridge_read_proc(char *buffer, char **start, off_t offset, int size, int *eof,
		void *data)
{
	struct avrBridge *dev;
	int retval;
